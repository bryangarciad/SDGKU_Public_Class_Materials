//
//  AudioManager.swift
//  MediaManagement Watch App
//
//  Created for MDI 113 - Class 2
//
...
class AudioManager: NSObject, ObservableObject {
    ...
    func requestPermission() async {        
        ...
        // Ensure the state update happens on the main thread
        DispatchQueue.main.async {
            self.hasPermission = permissionGranted // 'self' is likely your model or view model
        }
    }
